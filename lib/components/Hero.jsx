      ...
      <div style={{
        ...
        <div>
          ...
          >
            ...
            <span className="lbl" style={{ color: 'var(--on-ivory-mid)', fontSize: 9 }}>Open to Work</span>
          </motion.div>
          ...
          <div style={{ overflow: 'hidden', marginBottom: '0.15em' }}>
            <motion.h1
              ...
              style={{ fontSize: 'clamp(62px,9vw,130px)', fontWeight: 300, color: 'var(--ink)' }}
            >Crafting</motion.h1>
          </div>
          ...
          <div style={{ overflow: 'hidden', marginBottom: '0.15em' }}>
            <motion.h1
              ...
              style={{ fontSize: 'clamp(62px,9vw,130px)', fontWeight: 600, fontStyle: 'italic', color: 'var(--ink)' }}
            >Digital</motion.h1>
          </div>
          ...
          >
            Full-stack developer building aesthetic, precise, and impactful web systems —
            where engineering rigour meets design sensibility.
          </motion.p>
          ...
          >
            <a href="#work" style={{
              ...
              textTransform: 'uppercase', color: 'var(--ivory)', background: 'var(--ink)',
              padding: '13px 30px', borderRadius: 2, textDecoration: 'none', transition: 'background .3s',
            }}
            ...
            <button onClick={onCvClick} style={{
              ...
              border: '1px solid var(--gold-dim)', background: 'var(--gold-faint)',
              padding: '13px 24px', borderRadius: 2, cursor: 'pointer',
              display: 'flex', alignItems: 'center', gap: 7, transition: 'all .3s',
            }}
            ...
            ><span style={{ fontSize: 9 }}>↓</span> Resume</button>
          </motion.div>
        </div>
          ...
          <div style={{ position: 'relative', width: '100%', maxWidth: 420 }}>
            ...
            <div style={{ position: 'relative', borderRadius: 3, overflow: 'hidden', aspectRatio: '3/4', zIndex: 1 }}>
              ...
              <div style={{
                ...
                background: 'linear-gradient(to bottom, rgba(244,234,216,0.06) 0%, rgba(196,135,64,0.08) 100%)',
            ...
            <motion.div
              ...
              style={{
                ...
                background: 'var(--ink)', padding: '12px 20px', borderRadius: 2, zIndex: 4,
              }}
            >
